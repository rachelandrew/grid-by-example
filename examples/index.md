...
<p>Repeating the name of an area indicates that the area spans that grid track. Using a `.` or a sequence like `....` indicates an empty track. Such as the column between my sidebar and content.</p>
